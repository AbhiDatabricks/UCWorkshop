...
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=governance&org_id=4092582696636300&notebook=%2F00-Upgrade-database-to-UC&demo_name=uc-05-upgrade&event=VIEW&path=%2F_dbdemos%2Fgovernance%2Fuc-05-upgrade%2F00-Upgrade-database-to-UC&version=1">

-- COMMAND ----------

-- MAGIC %md 
-- MAGIC ### A cluster has been created for this demo
-- MAGIC To run this demo, just select the cluster `dbdemos-uc-05-upgrade-odl_instructor_788265` from the dropdown menu ([open cluster configuration](https://adb-4092582696636300.0.azuredatabricks.net/#setting/clusters/0802-030341-ek6rrzr4/configuration)). <br />
...
-- MAGIC %run ./_resources/00-setup $catalog=
...
CREATE EXTERNAL LOCATION IF NOT EXISTS `field_demos_external_location_uc_upgrade`
  URL 'abfss://adls-gen2@dbxlabswestusuc90.dfs.core.windows.net/external_location_uc_upgrade' 
  WITH (CREDENTIAL `labs-41989-csa795-metastore`)
...
LIST 'abfss://adls-gen2@dbxlabswestusuc90.dfs.core.windows.net/external_location_uc_upgrade' 
